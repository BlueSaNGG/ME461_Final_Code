...
//   RAMM1_RSVD      : origin = 0x0007F8, length = 0x000008     /* Reserve and do not use for code as per the errata advisory "Memory: Prefetching Beyond Valid Memory" */
   ...
   RAMGS1315     : origin = 0x019000, length = 0x002FF8
...
SECTIONS
{
   ...
   .stack              : > RAMD01       PAGE = 1
   .my_arrs			: > RAMGS0008 | RAMGS1315		PAGE = 1
   .my_vars			: > RAMGS0008 | RAMGS1315		PAGE = 1
   ...
   .init_array         : > FLASHA | FLASHB | FLASHC | FLASHD | FLASHE |
                            FLASHF | FLASHG | FLASHH | FLASHI | FLASHJ |
                            FLASHK | FLASHL | FLASHM | FLASHN,       PAGE = 0,       ALIGN(8)
   .bss                : > RAMGS0008 | RAMGS1315,       PAGE = 1
   .bss:output         : > RAMLS05,       PAGE = 0
   .bss:cio            : > RAMGS0008 | RAMGS1315,       PAGE = 1
   .data               : > RAMGS0008 | RAMGS1315,       PAGE = 1
   .sysmem             : > RAMGS0008 | RAMGS1315,       PAGE = 1
   ...
   .pinit              : > FLASHA | FLASHB | FLASHC | FLASHD | FLASHE |
                            FLASHF | FLASHG | FLASHH | FLASHI | FLASHJ |
                            FLASHK | FLASHL | FLASHM | FLASHN,       PAGE = 0,       ALIGN(8)
   .ebss               : >> RAMGS0008 | RAMGS1315,    PAGE = 1
   .esysmem            : > RAMGS0008 | RAMGS1315,       PAGE = 1
   .cio                : > RAMGS0008 | RAMGS1315,       PAGE = 1
   /* Initalized sections go in Flash */
...
*/
	...
	FFT_buffer_1 : >> RAMGS0008 | RAMGS1315, ALIGN = FFT_ALIGN

	FFT_buffer_2 : >> RAMGS0008 | RAMGS1315
	FPUmathTables : >> RAMGS0008 | RAMGS1315

	FPUfftTables : >> RAMGS0008 | RAMGS1315
	FpuRegsFile : >> RAMGS0008 | RAMGS1315
